...
@router.message(F.text == L.TASK_AFF(), IsDepFilter((MT_PARTNERS,)))
...
@router.message(F.text == L.TASK_CREO(), IsDepFilter((MT_PARTNERS,)))
...
@router.callback_query(StartAgainCreo.filter(), OrderCreoState.Preview, IsDepFilter((MT_PARTNERS,)))
