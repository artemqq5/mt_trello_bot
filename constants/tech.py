...
TECH_DEP_TASK = {
    ...
    GAMBLE_FB: (SHARE_APP, CREATE_CAMPAIGN, PWA_, OTHER_TECH),
    GAMBLE_UAC: (SHARE_APP, CREATE_CAMPAIGN, PWA_, OTHER_TECH),
...
OTHER_TECH_ACCESS = (ADMIN_, GAMBLE_PPC, GAMBLE_FB, GAMBLE_UAC, GAMBLE_UAC_PPC, DEV_TECH)
