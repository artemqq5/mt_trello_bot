...
MESSAGE_IS_TOO_LONG = "Ваше повідомлення занадто велике, спробуйте зменшити його загальну довжину (опис, формат тощо) і надіслати знову"
